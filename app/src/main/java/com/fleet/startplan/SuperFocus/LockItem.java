...
public class LockItem {
    ...
    public LockItem(int scId, String scEmoji, String scContents, String scCategory, int scComplete, String scCompletedTime, int scListPosition, int todoStartHour, int todoStartMinute, int todoEndHour,
    ...
    public static Comparator<LockItem> setLockItemList = new Comparator<LockItem>() {
        @Override
        public int compare(LockItem p1, LockItem p2) {
