...
public class SendTomorrow extends AppCompatActivity {

    private String mSelectedDate, mTomorrowDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            mTomorrowDate = intent.getStringExtra(DialogSend.SEND_TOMORROW_DATE);
        }

        if (mTomorrowDate.equals(getToday())) {
            mCompleteBtnText.setText("오늘로 보내기");
        } else {
            mCompleteBtnText.setText("<" + mTomorrowDate + ">" + "로 보내기");
        }
        ...
        mSendComplete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(copyItems.size()!=0) {
                    mDBHelper.insertCopySchedule(copyItems, mTomorrowDate);
