...
public class BringTomorrow extends AppCompatActivity {

    private String mStandardDate, mTomorrowDate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            mTomorrowDate = intent.getStringExtra(DialogBring.BRING_TOMORROW_DATE);
        }
        ...
        ArrayList<CopyItem> copyItems = mDBHelper.getBringData(mTomorrowDate);
